...
install -m 0644 "${UNITS_SRC}/indemnite-scrape-retry@.service" "${SYSTEMD_DIR}/indemnite-scrape-retry@.service"
install -m 0644 "${UNITS_SRC}/indemnite-scrape-retry@.timer"   "${SYSTEMD_DIR}/indemnite-scrape-retry@.timer"
